...
<html lang="ko">
    ...
    <head>
        ...
        <!-- Bootstrap Core CSS -->
        <link rel="stylesheet" href="resource/assets/css/bootstrap.css" rel="stylesheet">
        <!-- Template CSS -->
        <link rel="stylesheet" href="resource/assets/css/animate.css" rel="stylesheet">
        <link rel="stylesheet" href="resource/assets/css/font-awesome.css" rel="stylesheet">
        <link rel="stylesheet" href="resource/assets/css/nexus.css" rel="stylesheet">
        <link rel="stylesheet" href="resource/assets/css/responsive.css" rel="stylesheet">
        <link rel="stylesheet" href="resource/assets/css/custom.css" rel="stylesheet">
        <!-- Google Fonts-->
    ...
    <body>
        <div id="body-bg">
                    ...
                    <div class="row">
                        ...
                        <div class="logo">
                            <a href="index.html" title="">
                                <img src="resource/assets/img/logo.png" alt="Logo" />
                            </a>
                        </div>
                        <!-- End Logo -->
                    </div>
            ...
            <!-- End Footer -->
            <!-- JS -->
            <script type="text/javascript" src="resource/assets/js/jquery.min.js" type="text/javascript"></script>
            <script type="text/javascript" src="resource/assets/js/bootstrap.min.js" type="text/javascript"></script>
            <script type="text/javascript" src="resource/assets/js/scripts.js"></script>
            <!-- Isotope - Portfolio Sorting -->
            <script type="text/javascript" src="resource/assets/js/jquery.isotope.js" type="text/javascript"></script>
            <!-- Mobile Menu - Slicknav -->
            <script type="text/javascript" src="resource/assets/js/jquery.slicknav.js" type="text/javascript"></script>
            <!-- Animate on Scroll-->
            <script type="text/javascript" src="resource/assets/js/jquery.visible.js" charset="utf-8"></script>
            <!-- Sticky Div -->
            <script type="text/javascript" src="resource/assets/js/jquery.sticky.js" charset="utf-8"></script>
            <!-- Slimbox2-->
            <script type="text/javascript" src="resource/assets/js/slimbox2.js" charset="utf-8"></script>
            <!-- Modernizr -->
            <script src="resource/assets/js/modernizr.custom.js" type="text/javascript"></script>
            <!-- End JS -->
    </body>
</html>
<!-- === END FOOTER === -->